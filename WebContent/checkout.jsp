...
<div class="container">
    ...
    <div class="table-responsive">
		  ...
		  <tr class="cart-header">
			<td class="ring-in"><a href="single.jsp" class="at-in"><img src="${commodityDetails.cd_img }" class="img-responsive" alt=""></a>
			<div class="sed">
				<h5><a href="single.jsp">${commodityDetails.cd_name }</a></h5>
				<p>${commodityDetails.cd_describe } </p>
			
			</div>
			<div class="clearfix"> </div>
			<div class="close1"> </div></td>
			<td>$${commodityDetails.cd_gross }</td>
			<td>${commodityDetails.cd_free }</td>
			<td class="item_price">$${commodityDetails.cd_gross }</td>
			<td class="add-check"><a class="item_add hvr-skew-backward" href="pay.jsp">支付</a></td>
		  </tr>
	...
	<div class="produced">
	<a href="shopping_findById?cd_id=${commodityDetails.cd_id }" class="hvr-skew-backward">返回商品详情</a>
	 </div>
    </div>
</div>
