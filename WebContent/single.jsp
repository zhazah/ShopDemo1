...
<div class="col-md-9">
	<div class="col-md-5 grid">		
		<div class="flexslider">
			  <ul class="slides">
			    <li data-thumb="${commodityDetails.cd_img }">
			        <div class="thumb-image"> <img src="${commodityDetails.cd_img }" data-imagezoom="true" class="img-responsive"> </div>
			    </li>
			    <li data-thumb="${commodityDetails.cd_img }">
			         <div class="thumb-image"> <img src="${commodityDetails.cd_img }" data-imagezoom="true" class="img-responsive"> </div>
			    </li>
...
<div class="col-md-7 single-top-in">
				...
				<h3>${commodityDetails.cd_name }</h3>
				<p class="in-para">${commodityDetails.cd_describe }</p>
			    <div class="price_single">
				  <span class="reducedfrom item_price">￥ ${commodityDetails.cd_gross }</span>
				 <a href="#">click for offer</a>
				 <div class="clearfix"></div>
				</div>
				<h4 class="quick">概述:</h4>
				<p class="quick_desc"><font color="blue"> ${commodityDetails.cd_gaishu }</font></p>
			    <div class="wish-list">
				 	<ul>
	...
	<!--quantity-->
			    ...
			    <a href="shopping_findShopId?cd_id=${commodityDetails.cd_id }" class="add-to item_add hvr-skew-backward">添加购物车</a>
			<div class="clearfix"> </div>
			</div>
		...
		<ul class="nav tabs">
          <li class="active"><a href="#tab1" data-toggle="tab">产品信息描述</a></li>
          <li class=""><a href="#tab2" data-toggle="tab">其他信息</a></li> 
...
<div class="tab-pane active text-style" id="tab1">
 <div class="facts">
									  <p > 人生如路，须在荒凉中走出繁华的风景来。
									  		那场相遇，惊鸿一瞥，扰乱了寂寞年华，谁在月老前求一段姻缘。 那场恩怨，血染繁花，映红了地狱彼岸，
											 谁在忘川河唱一曲悲歌。我以为你的身后是我的三寸天堂，却发现那段流年微漾，抵不过时光。今夜雪霏霏，眼中无泪，反侧难以入睡；说着无谓，却忘不了谁独自伤悲。
...
<div class="tab-pane text-style" id="tab2">
									...
									<div class="facts">									
										<p > 一、旋舞的蝴蝶，它的翅膀承载了美丽的梦想，却承载不了淡淡的忧伤;飘扬的旗帜，绽放着青春的热忱，却记写不了悠悠的心事;安静的键盘，敲打华丽的字章，却无法诉说内心的孤单。

												二、一个人只要不再想要，就什么都可以放下。

													三、当风吹过平静的沙滩，轻轻抚平那些字，爱也悄悄落泪，不再解释任何，我的内心一片平静，一个人的时候，有点蓝色的向往，此生与你的相约，我愿画地为牢。

														四、天空的飞鸟，是你的寂寞比我多，还是我的忧伤比你多，剩下的时光，你陪我，好不好，这样你不寂寞，我也不会忧伤。 </p>
										<ul >
